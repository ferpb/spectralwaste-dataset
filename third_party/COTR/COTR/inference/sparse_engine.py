...
class SparseEngine():
    def __init__(self, model, batch_size, mode='stretching', verbose=False):
...
class FasterSparseEngine(SparseEngine):
    ...
    def __init__(self, model, batch_size, mode='stretching', max_load=256, verbose=False):
        super().__init__(model, batch_size, mode=mode, verbose=verbose)
